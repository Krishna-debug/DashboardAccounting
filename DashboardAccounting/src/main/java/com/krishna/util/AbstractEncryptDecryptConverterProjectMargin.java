...
public abstract class AbstractEncryptDecryptConverterProjectMargin<X>  implements AttributeConverter<X, String> {
	...
	@Value("${com.oodles.project.margin.key}")
	public void  setKey(String key) {
		AbstractEncryptDecryptConverterProjectMargin.SECRET_ENCRYPTION_KEY=key;
	}
	
	
	public AbstractEncryptDecryptConverterProjectMargin(CipherMaker cipherMaker) {
		
		  this.cipherMaker = cipherMaker;
	}
	
	public AbstractEncryptDecryptConverterProjectMargin() {
